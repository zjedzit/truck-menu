...
async def send_print_job(request: Request):
    ...
    try:
        ...
        # For now, we broadcast it, and the RPi agent with matching key will pick it up
        ...
        while True:
            ...
            try:
                ...
                if m_type in ["register", "device_status"]:
                    ...
                    # Obsługa ACK z RPi (potwierdzenie wydruku) — aktualizacja bazy i rozgłoszenie
...
# Kiosk Wydawka - dedykowany interfejs dla Raspberry Pi
@app.get("/kiosk/wydawka", response_class=HTMLResponse)
@app.get("/kiosk", response_class=HTMLResponse)
async def kiosk_wydawka_page(request: Request):
    """Dedykowany interfejs kiosku wydawki dla Raspberry Pi"""
